...
#define MS_OS_STRING  'M','S','F','T','1','0','0'
#define MS_OS_SIZE    7
#define MS_OS_INDEX   0xEE

UTF16LE_PACKED_STATIC_CONST_STRING_DESC( msOSDesc[], MS_OS_STRING, MS_OS_SIZE );
      ...
      (USB_SETUP_DIR_D2H | USB_SETUP_TYPE_STANDARD | USB_SETUP_RECIPIENT_DEVICE))
  {
    ...
    switch (myUsbDevice.setup.wValue >> 8)
    {
      ...
      case USB_STRING_DESCRIPTOR:
        ...
        // Index 0xEE is the Microsoft OS String Descriptor request.
        else if (index == MS_OS_INDEX)
        {
          //dat = msOSDesc;
        }
        ...
        else if ((myUsbDevice.setup.wIndex == 0) || (myUsbDevice.setup.wIndex == SLAB_USB_LANGUAGE))
        {
          ...
          if (index < myUsbDevice.numberOfStrings)// || index == MS_OS_INDEX)
          {
